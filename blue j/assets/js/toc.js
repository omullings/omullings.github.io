    ...
    Toc.prototype = {
        ...
        render: function() {
            ...
            for (var i = 0; i < numHeadings; i++) {
                ...
                var id        = this.generateHeadingId(headings[i]),
                    ...
                    $a        = $('<a/>').html('<span class="step_label">'+$(headings[i]).text()+'</span')
        ...
        prependIndexing: function(index, linkElement) {
            ...
            if (converted.length > 0) {
                ...
                $(linkElement).prepend('<span class="step_number">'+ text +'</span>');
                $(heading).prepend( '<span class="step_number">'+ text +'</span>');
            }
        },
